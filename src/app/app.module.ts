...
import { NavBarComponent } from './components/common components/nav-bar/nav-bar.component';
import { RecordsTableComponent } from './components/common components/records-table/records-table.component';
